...
import { currentUser, growthGoals, GrowthGoal } from "@/data/mockData";
...
interface CreatePostProps {
  onPost?: (content: string, tags: GrowthGoal[]) => void;
}
  ...
  return (
    <div className="gradient-card rounded-2xl p-5 shadow-warm border border-border">
      ...
      <div className="flex items-center justify-between mt-3 pt-3 border-t border-border">
        ...
        <Button size="sm" className="rounded-full" onClick={handlePost} disabled={!content.trim()}>
          Post
        </Button>
      </div>
    </div>
